...
class ReasoningValidator:
    ...
    EXPLICIT_THINKING_KEYWORDS = [
        "because", "since", "therefore", "thus", "reasoning",
        "understand", "need to", "should", "considering"
    ]

    ALTERNATIVE_KEYWORDS = [
        "alternative", "instead", "could also", "another option",
        "considered", "compared to", "versus", "or"
    ]

    CONFIDENCE_KEYWORDS = ["confidence", "high", "medium", "low", "certain", "uncertain"]
    ...
    def _check_explicit_thinking(
        ...
        keyword_count = sum(
            1 for keyword in self.EXPLICIT_THINKING_KEYWORDS
    ...
    def _check_alternatives(
        ...
        keyword_count = sum(
            1 for keyword in self.ALTERNATIVE_KEYWORDS
            if keyword in reasoning_lower
        )
    ...
    def _check_assumptions(
        ...
        keyword_count = sum(
            1 for keyword in self.ASSUMPTION_KEYWORDS
            if keyword in reasoning_lower
        )
