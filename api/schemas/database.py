...
class SongResponse(BaseModel):
    ...
    lyrics: Optional[str] = Field(None, description="Song lyrics (if available)")
...
class SongSearchRequest(BaseModel):
    ...
    query: Optional[str] = Field(None, description="Search query (lyrics, title)")
    mood: Optional[str] = Field(None, description="Filter by mood")
    album: Optional[str] = Field(None, description="Filter by album")
